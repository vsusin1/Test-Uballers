...
- Si vous utilisez **Laragon** ou **WampServer**, placez le dossier contenant le projet dans le dossier `/www` de l'emplacement d'installation de Laragon/WampServer. Exemple: `C:\laragon\www\`, ou `C:\wamp\www\`.
